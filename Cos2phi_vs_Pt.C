...
void Cos2phi_vs_Pt() {
    ...
    TH2D* H2D_2Cos2phi_vs_Pt = (TH2D*) InputFile->Get("hCos2phivsPT");
    ...
    //
    TProfile* profileX = H2D_2Cos2phi_vs_Pt->ProfileX();
    ...
    profileX->GetXaxis()->SetTitle("P_{T} (GeV/c)");
    profileX->GetXaxis()->SetRangeUser(0.5, 1.3);
    ...
    c1->SaveAs("Images/Cos2phi_vs_Pt.pdf");
    c1->SaveAs("Images/Cos2phi_vs_Pt.png");
